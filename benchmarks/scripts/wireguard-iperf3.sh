#!/bin/bash
#--------------------------------
#IPERF3 WIREGUARD automatisiert
...
ergebnis=~/ansible/ergebnisse/iperf3/wireguard
...
befehl='NR=$(hostname | grep -o "[0-9]*"); NR=${NR#0}; PORT=$((5200 + NR)); iperf3 -c 10.0.0.200 -p $PORT -t 10'
